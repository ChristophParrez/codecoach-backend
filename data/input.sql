...
VALUES ('FreeDb_dummySessoin_12', '2022-01-25', '(R1) How to write a good sql file for my Spring project', 'SQL', '19:00:00','FreeDb_userCoach_1', 'FreeDb_userCoachee_1', 'Online', 'REQUESTED');
--2 SQL sessions to be cancelled (REQUESTED)
INSERT INTO sessions (session_id, date, remarks, subject, time, coach, coachee, location, status)
VALUES ('FreeDb_dummySessoin_2', '2022-01-21', '(R2) How to set up a table with SQL?', 'SQL', '18:30:00','FreeDb_userCoach_1', 'FreeDb_userCoachee_1', 'Online', 'REQUESTED');
--INSERT INTO sessions (session_id, date, remarks, subject, time, coach, coachee, location, status)
...
INSERT INTO sessions (session_id, date, remarks, subject, time, coach, coachee, location, status)
VALUES ('FreeDb_dummySessoin_4', '2022-02-23', '(A1) Explanations on Spring data', 'Spring', '19:00:00','FreeDb_userCoach_1', 'FreeDb_userCoachee_1', 'Online', 'ACCEPTED');
...
INSERT INTO sessions (session_id, date, remarks, subject, time, coach, coachee, location, status)
VALUES ('FreeDb_dummySessoin_6', '2022-02-23', 'Explanations on Spring core', 'Spring', '18:00:00','FreeDb_userCoach_1', 'FreeDb_userCoachee_1', 'Online', 'FINISHED_CANCELLED_BY_COACH');
...
--1 session in the future, ACCEPTED by coach
INSERT INTO sessions (session_id, date, remarks, subject, time, coach, coachee, location, status)
VALUES ('FreeDb_dummySessoin_9', '2022-02-23', '(A2)Explanations on Spring web', 'Spring', '19:00:00','FreeDb_userCoach_1', 'FreeDb_userCoachee_1', 'Online', 'ACCEPTED');
--1 session done where I can give feedback (ACCEPTED -> DONE WAITING FOR FEEDBACK)
INSERT INTO sessions (session_id, date, remarks, subject, time, coach, coachee, location, status)
VALUES ('FreeDb_dummySessoin_10', '2021-12-14', '(F1) formatting problems in SQL', 'SQL', '19:00:00','FreeDb_userCoach_1', 'FreeDb_userCoachee_1', 'Online', 'ACCEPTED');
...
VALUES ('FreeDb_dummySessoin_11', '2021-12-12', '(F2) Issues with executing SQL on my database', 'SQL', '19:00:00','FreeDb_userCoach_1', 'FreeDb_userCoachee_1', 'FreeDb_userCoachee_1_feedback1', 'Online', 'DONE_WAITING_FOR_FEEDBACK');
...
--1 extra session for the final presentation
INSERT INTO sessions (session_id, date, remarks, subject, time, coach, coachee, location, status)
VALUES ('FreeDb_dummySessoin_13', '2022-01-03', '(R3) I need help with Spring Security', 'Spring', '10:00:00','FreeDb_userCoach_1', 'FreeDb_userCoachee_1', 'Online', 'REQUESTED');
